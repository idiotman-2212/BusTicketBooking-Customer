  ...
  return (
    <Box mt="100px">
      ...
      <Box bgcolor={colors.primary[100]} mt="40px" borderRadius="8px">
        <Paragraph
          title={"Đặt vé trực tuyến trên DATVEXE"}
          content={
